...
categories
```
Ugh, that's quite a lot of offices. Let's jsut focus on the Southwest, since they have, by far, the most apprehensions.

In addition, I'd like to see if more single adults are apprehended, since I've heard tell from people on TV that people STREAMING over the border are all the "BAD ONES" and not families. I will make a little graphic showing columns of apprehended folks by office, and then a breakdown of their demographic status (Families (FMUA), Single adults, Unaccompanied Children, or Accompanied Children). 
